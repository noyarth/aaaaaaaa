...
return {
	...
	PoliceArmoury = {
		...
		blip = {
			...
			{ loc = vec3(485.150269, -995.304993, 30.689642), length = 0.8, width = 3.0, heading = 356.790955, minZ = 30.00, maxZ = 32.0, distance = 6 }
		}
	},
	...
	Medicine = {
		...
		blip = {
			...
			{ loc = vec3(310.119904, -568.369202, 43.284092), length = 0.5, width = 3.0, heading = 270.0, minZ = 43.28, maxZ = 45.28, distance = 6 }
		}
	},
