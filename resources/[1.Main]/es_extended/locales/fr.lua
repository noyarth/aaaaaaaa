Locales['fr'] = {
  ...
  ['command_setfaction'] = 'assigner faction à un joueur',
  ['command_setjob_job'] = 'nom du job',
  ['command_setfaction_faction'] = 'nom de la faction',
  ['command_setjob_grade'] = 'grade du job',
  ['command_setfaction_grade'] = 'grade de la faction',
  ['command_setjob_invalid'] = 'le job, le grade ou les deux sont invalides',
  ['command_setfaction_invalid'] = 'la faction, le grade ou les deux sont invalides',
