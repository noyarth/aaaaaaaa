RegisterNetEvent('oliann_garages:ThrowError', function(text)
    error(text)
end)

if Config.EnableVersionCheck then lib.versionCheck('Oliann/oliann_garages') end
...
lib.callback.register('oliann_garages:GetVehicles', function(source, garageType, job)
...
lib.callback.register('oliann_garages:GetImpound', function(source, type)
    local xPlayer = ESX.GetPlayerFromId(source)
    local identifier = xPlayer.getIdentifier()
    local vehicles = {}
...
lib.callback.register('oliann_garages:CheckOwnership', function(source, plate, model, currentGarage)
    local xPlayer = ESX.GetPlayerFromId(source)
    local identifier = xPlayer.getIdentifier()
...
RegisterNetEvent('oliann_garages:ChangeStored', function(plate)
...
RegisterNetEvent('oliann_garages:SaveVehicle', function(vehicle, plate, ent, garage)
...
RegisterNetEvent('oliann_garages:SpawnVehicle', function(model, plate, coords, heading, price)
