...
registercallback('oliann_multicharacter:choosecharacter', function(source,slot)
...
registercallback('oliann_multicharacter:createcharacter', function(source,data)
...
registercallback('oliann_multicharacter:deletecharacter', function(source,slot)
	return Config.CanDelete and DeleteCharacter(source,slot)
end)

registercallback('oliann_multicharacter:saveappearance', function(source,skin)
