...
lib.callback.register('oliann_hunting:removeMoney', function(source, amount)
...
RegisterNetEvent('oliann_hunting:deleteCarAndRedeem')
AddEventHandler('oliann_hunting:deleteCarAndRedeem', function(vehNetId, amount)
