...
Config.IBANChangeCost = 100 -- How much it costs to change the IBAN to a custom one (on Settings tab)

Config.PINChangeCost = 30 -- How much it costs to change the PIN (on Settings tab)
...
Config.BankLocations = { -- to get blips and colors check this: https://wiki.gtanet.work/index.php?title=Blips
	...
	{blip = 108, blipColor = 3, blipScale = 0.8, x = 237.41, y = 217.73, z = 106.29, blipText = "Bank", BankDistance = 3},
