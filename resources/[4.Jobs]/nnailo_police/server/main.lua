...
AddEventHandler('esx_policejob:drag', function(target)
	...
	if xPlayer.job.name == 'police' or xPlayer.job.name == 'tanod' then
...
ESX.RegisterUsableItem('polbadge', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerEvent('policebadge:badge', source)
end)

RegisterNetEvent('policebadge:badge')
AddEventHandler('policebadge:badge', function(source, args, rawCommand)
...
-- RegisterCommand("badge", function(source, args, rawCommand)
    ...
    TriggerClientEvent('sendBadgePolice', src, data.firstname.." "..data.lastname )
end, true)

RegisterNetEvent('message:badge')
AddEventHandler('message:badge', function(messagehueifh)
    local src = source        

    local msg = messagehueifh
    TriggerClientEvent('chat:addMessage', src, {
        template = '<div style = "display: inline-block !important;padding: 0.6vw;padding-top: 0.6vw;padding-bottom: 0.7vw;margin: 0.1vw;margin-left: 0.4vw;border-radius: 10px;background-color: #000000;width: fit-content;max-width: 100%;overflow: hidden;word-break: break-word;"><b>👮‍♂️LSPD Badge</b>: {1}</div>',
        args = { fal, msg }
    })
end)

RegisterNetEvent('message:inDistanceZoneBadge')
AddEventHandler('message:inDistanceZoneBadge', function(somethingsomething, messagehueifh)
    local src = source        

    local msg = messagehueifh
    TriggerClientEvent('chat:addMessage', somethingsomething, {
        template = '<div style = "display: inline-block !important;padding: 0.6vw;padding-top: 0.6vw;padding-bottom: 0.7vw;margin: 0.1vw;margin-left: 0.4vw;border-radius: 5px;background-color: #000000;width: fit-content;max-width: 100%;overflow: hidden;word-break: break-word;"><b>👮‍♂️LSPD Badge</b>: {1}</div>',
        args = { fal, msg }
    })
end)
...
AddEventHandler('message:inDistanceZone', function(somethingsomething, messagehueifh)
    ...
    local msg = messagehueifh
    TriggerClientEvent('chat:addMessage', somethingsomething, {
        template = '<div style = "display: inline-block !important;padding: 0.6vw;padding-top: 0.6vw;padding-bottom: 0.7vw;margin: 0.1vw;margin-left: 0.4vw;border-radius: 5px;background-color: #000000;width: fit-content;max-width: 100%;overflow: hidden;word-break: break-word;"><b>👮‍♂️LSPD </b>: {1}</div>',
        args = { fal, msg }
    })
end)
