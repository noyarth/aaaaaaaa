...
Config.Zones = {
	...
	VehicleSpawnPoint = {
		Pos   = vector3(862.54, -2139.64, 30.59),
...
Config.cars = {
	...
	{nom = "towtruck2", modele = "towtruck2"},
	{nom = "slamvan3", modele = "slamvan3"},
}

Config.Plate = "Mech"

Config.Mech = {
    SpawnVeh = vector4(861.225220, -2126.898438, 30.541363, 357.484161),
}
...
Config.LSCustomZones = {
	...
	ls1 = {
		Pos   = { x = 875.947266, y = -2124.672607, z = 30.206543},
	...
	ls2 = {
		Pos   = { x = 887.142883, y = -2126.017578, z = 30.206543}, 
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = {  x = 897.692322, y = -2127.006592, z = 30.206543},   
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = {  x = 909.112061, y = -2127.863770, z = 30.206543},   
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = 888.079102, y = -2102.043945, z = 30.105469},   
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls6 = {
		Pos   = { x = 895.951660, y = -2102.914307, z = 30.105469},   
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
